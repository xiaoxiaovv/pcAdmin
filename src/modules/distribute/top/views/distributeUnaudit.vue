    ...
    <el-table
      ...
      label="操作">
        <template slot-scope="scope">
          ...
          <el-button type="text" @click="distributeUpdateAudit(scope.row.id,3)" :disabled="scope.row.status===2?false:true">通过审核</el-button>
          <el-button type="text" @click="distributeUpdateAudit(scope.row.id,6)" :disabled="scope.row.status===2?false:true">驳回审核</el-button>
        </template>
      </el-table-column>
    </el-table>
