    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <template v-if="userTypeVal === 1">
            <el-button type="text" @click="OperatorUpdateAudit(scope.row.id,3)">通过审核</el-button>
            <el-button type="text" @click="OperatorUpdateAudit(scope.row.id,6)">驳回审核</el-button>
          </template>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  created () {
    let userTypeVal = parseInt(sessionStorage.userType)
