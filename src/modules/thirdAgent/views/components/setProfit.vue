...
export default {
  ...
  data () {
    ...
    return {
      tipTextA: `${levelAlias.thirdName}的分佣比例，比如填写60%，则分商户流水佣金的60%给${levelAlias.thirdName}`,
      tipTextB: `${levelAlias.thirdName}的分佣比例，比如填写60%，则分商户流水佣金的60%给${levelAlias.thirdName}`,
      payWay: 1,
      params: {
        zfbPayProrata: null,
        wxPayProrata: null,
