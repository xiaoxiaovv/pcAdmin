    ...
    <div class="input-form" id="create" v-show="vshowDrag">
      ...
      <el-form ref="form" :model="currentNode" label-width="70px" class="editForm">
        ...
        <el-form-item label="是否启用">
          <el-switch v-model="currentNode.delFlag" class="input-item"></el-switch>
        </el-form-item>
        <el-form-item>
          <el-button @click="vshowDrag = false">取消</el-button>
    ...
    <el-dialog
      ...
      <el-form :model="submenuForm">
        <el-form-item label="属于" :label-width="formLabelWidth">
          <el-input v-model="currentNode.name" :disabled="true"></el-input>
        </el-form-item>
        <el-form-item label="名称" :label-width="formLabelWidth">
    ...
    editPermission () {
      ...
      if (this.currentNode.id === '') {
        ...
        editPermission({
          ...
          visible: this.currentNode.type === 1 ? 0 : 1
        }).then(response => {
          this.$message({
