            ...
            <el-form :model="form">
                ...
                <el-form-item label="公司类型" :label-width="formLabelWidth">
                    <el-select v-model="form.type" placeholder="请选择">
                      <el-option :label="`${levelAlias.oemName}`" :value="1"> </el-option>
                      <el-option :label="`${levelAlias.firstName}`" :value="2"> </el-option>
                      <el-option :label="`${levelAlias.secondName}`" :value="3"> </el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="员工等级" :label-width="formLabelWidth">
...
export default {
   ...
   * */
    ...
    addRole () {
      ...
      addRole(this.form.name, this.form.isDefault, this.form.type, this.form.kind, this.form.level).then(response => {
        this.$message({
          message: response.msg,
          type: 'success'
        })
