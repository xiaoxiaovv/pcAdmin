  ...
  <div class="login-container" v-bind:style="bgStyle">
    ...
    <div class="header-bar">
      ...
      <div class="service-info">
        ...
        <div class="wx-box"><img src="../../assets/images/login/weChat.png" class="wxlogo" alt=""><span>关注微信公众号</span>
        </div>
      </div>
    </div>
    ...
    <el-form class="login-form loginform">
      ...
      <div class="header-logo">
        ...
        <span class="nor-title">后台管理系统</span>
      </div>
      <div class="form-box">
    ...
    getInfo: function () {
      getSiteInfo().then(res => {
        ...
        if (data.bgmPhoto !== '' && data.bgmPhoto != null) {
          this.siteInfo.bg = "url('" + this.getImg(data.bgmPhoto) + "') no-repeat"
...
<style rel="stylesheet/scss" lang="scss" scoped>
  ...
  .login-btn {
    width: 100%;
    border: 0;
    background-color: rgba(62, 189, 255, 1);
  }
