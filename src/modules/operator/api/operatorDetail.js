...
export function getDistributeList(pageNumber, pageSize, parentId, type) {
  return request({
    url: '/auth/company/opera/find_by_parent_id',
    method: 'get',
    params: {
      pageNumber: pageNumber,
      pageSize: pageSize,
...
export function getMerchantListByCompanyId (pageNumber, pageSize, companyId) {
  return request({
    ...
    url: '/merchant/merchant/merchant_detail_list',
    method: 'get',
    params: {
      pageNumber: pageNumber,
      pageSize: pageSize,
