      ...
      <div>
        ...
        <el-form :model="form" ref="form" :rules="rules" :label-width="labelWidth" :size="inputSize">
          ...
          <el-form-item label="微信费率：" prop="rate_wx">
            <el-input-number v-model="form.rate_wx" :min="0" :precision="4" :max="1" :step="0.001" laceholder="微信费率"
                             class="standard-form"></el-input-number>
          </el-form-item>
          <el-form-item label="支付宝费率：" prop="rate_alipay">
            <el-input-number v-model="form.rate_alipay" :min="0" :precision="4" :max="1" :step="0.001"
                             laceholder="支付宝费率"
                             class="standard-form"></el-input-number>
          </el-form-item>
