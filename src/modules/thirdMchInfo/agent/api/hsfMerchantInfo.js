...
export function getMchInfoList(pageNumber, pageSize) {
  return request({
    url: '/merchant/merchant/hsf_mch_info/find_by_fuwushang',
    method: 'get',
    params: {
...
export function hsfRegister(id) {
  return request({
    url: '/merchant/hsf_mch_info/internal/registernewmerchant',
    method: 'post',
    data: qs.stringify({
      merchantId: id
    })
...
export function hsfImageRegister(id) {
  return request({
    url: '/merchant/hsf_mch_photo/internal/registernewmerchant',
    method: 'post',
    data: qs.stringify({
      merchantId: id
    })
